...
export const MODELS: MlModel[] = [
  {
    id: "2705b2b5-cc2a-4742-b100-fa3513a36918",
    name: "Niche Model: Bakery & Café",
    scope: "Niche",
    niche: "Bakery & Café",
    version: "v20260707024211",
    baselineAccuracy: 73.3,
    rollingAccuracy: 73.3,
    is_active: true,
    trained: "2 hours ago",
    rolling30d: synthRolling(73.3, false),
  },
  {
    id: "a1f1e078-28e7-49d8-9645-bd59403a3b68",
    name: "Niche Model: Fitness & Wellness",
    scope: "Niche",
    niche: "Fitness & Wellness",
    version: "v20260707024126",
    baselineAccuracy: 58.3,
    rollingAccuracy: 58.3,
    is_active: true,
    trained: "2 hours ago",
    rolling30d: synthRolling(58.3, false),
  },
  {
    id: "d80977bf-dc50-4471-b098-6ed14516e66c",
    name: "Personal Model: Lasence Bakeshop",
    scope: "Personal",
    niche: "Bakery & Café",
    version: "v20260707033415",
    baselineAccuracy: 70.0,
    rollingAccuracy: 70.0,
    is_active: true,
    trained: "12 hours ago",
    rolling30d: synthRolling(70.0, false),
  },
  {
    id: "320f0b3e-19db-4f88-af41-72d191399129",
    name: "Personal Model: Bison Gym",
    scope: "Personal",
    niche: "Fitness & Wellness",
    version: "v20260707033358",
    baselineAccuracy: 58.3,
    rollingAccuracy: 58.3,
    is_active: true,
    trained: "12 hours ago",
