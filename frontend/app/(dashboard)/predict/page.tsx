...
export default function PredictPage() {
  ...
  // AI semantic read of the free-form visual concept (guidance, not model input)
                          ...
                          <div>
                            ...
                            <div className="mt-2 flex items-center justify-between gap-3">
                              <p className="text-[10px] text-muted-foreground/70">
                                AI reads scripts, dialogue, and shot lists in any format — this guides
                                suggestions, it doesn&apos;t change the score.
                              </p>
                              <button
                                type="button"
                              ...
                              <div className="mt-3 rounded-xl border border-border bg-surface-2/50 p-4 space-y-3">
                                ...
                                {conceptAnalysis.hook && (
                                  <p className="text-[10px] text-muted-foreground">
                                    <span className="font-bold text-foreground">Hook:</span>{" "}
                                    &quot;{conceptAnalysis.hook}&quot;
                                  </p>
                                )}
