        ...
        <section className="relative hidden overflow-hidden bg-primary p-10 text-primary-foreground lg:flex lg:flex-col lg:justify-between xl:p-14">
          <div>
            <div>
              ...
              <div className="mt-0.5 text-xs text-primary-foreground/65">Content intelligence</div>
            </div>
          </div>

          <div className="max-w-xl py-14">
            <div className="mb-6 text-xs font-semibold text-primary-foreground/65">Decide before publishing</div>
            ...
            <p className="mt-6 max-w-lg text-[15px] leading-7 text-primary-foreground/75">
          ...
          <ul className="grid gap-3" aria-label="How FAIV supports decisions">
            {DECISION_STEPS.map((step) => (
              <li key={step} className="border-t border-primary-foreground/15 pt-3 text-sm text-primary-foreground/80">{step}</li>
            ))}
          </ul>
        </section>
