...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { to: "/stories", label: "Story Analytics", icon: BarChart3 },
            ...
            <div className="flex items-center gap-1">
              ...
              <div ref={topbarRef} className="relative">
                <div
                  ...
                  className="ml-1 hidden cursor-pointer items-center gap-2 rounded-lg border border-border bg-surface/60 px-2 py-1 transition-colors hover:bg-surface-2 sm:flex"
                >
